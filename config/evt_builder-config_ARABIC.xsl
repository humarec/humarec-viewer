...
<xsl:stylesheet xpath-default-namespace="http://www.tei-c.org/ns/1.0"
	...
	<xsl:param name="welcomeMsg">
		<div>
			<p class="title main">Welcome to the Humarec Manuscript Viewer</p>
		</div>	
		<div><p>This edition is created by Vital-DH@Vital-IT with the visualization tool <a href="http://vbd.humnet.unipi.it/">EVT</a>.</p> </div>		
		<p>This is a work in progress.
		</p>
		<p>For more information, consult our <a href="http://humarec.vital-it.ch">homepage</a>.</p>
	...
	<xsl:variable name="edition_array" as="element()*">
		<edition>arabic_diplomatic</edition> 
		...
		<edition>arabic_normalized</edition>	
