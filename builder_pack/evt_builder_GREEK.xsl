...
<xsl:stylesheet xpath-default-namespace="http://www.tei-c.org/ns/1.0"
	...
	<!-- Basic -->
	<xsl:include href="modules/evt_builder-main_GREEK.xsl"/>
	<xsl:include href="../config/evt_builder-config_GREEK.xsl"/>

	<xsl:include href="modules/fundamental_units/evt_builder-copy_and_call_main.xsl"/>
	<xsl:include href="modules/fundamental_units/evt_builder-structure_GREEK.xsl"/>
	...
	<!-- Elements -->
	<xsl:include href="modules/elements/evt_builder-divLine_GREEK.xsl"/>
